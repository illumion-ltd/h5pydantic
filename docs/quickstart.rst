...
This quickstart assumes fundamental knowledge about Pydantic, HDF5
files and the H5py library.
...
this quickstart will use a greatly simplified Synchrotron use case.
